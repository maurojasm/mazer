...
public:
    /*
    Constructor - seeds srand with time
    */
    Maze_Gen();

    /*
    Returns a random maze of a given size

    @param size size of the maze to return. Default is 5.
    @return     maze of given size in hex format
    */
